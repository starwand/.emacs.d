...
;;; Load my packages.
(use-package my-emacs            :load-path "my-packages" :straight nil)
...
(use-package my-eshell           :load-path "my-packages" :straight nil)
(use-package my-xterm-color      :load-path "my-packages" :straight nil)
